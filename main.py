...
class I2COutManager:
    ...
    def activate_out_pin(self, number, path):
        self.i2cPinsList[path] = i2c_pin.I2CPin(self.register, number, path)

i2cPin1 = i2c_pin.I2CPin(0x20, 0, "home/bedroom/switch1")
i2cPin2 = i2c_pin.I2CPin(0x20, 1, "home/bedroom/switch2")
i2cPin3 = i2c_pin.I2CPin(0x20, 2, "home/bedroom/switch3")
i2cPin4 = i2c_pin.I2CPin(0x20, 3, "home/bedroom/switch4")
i2cPin5 = i2c_pin.I2CPin(0x20, 4, "home/bedroom/switch5")
i2cPin6 = i2c_pin.I2CPin(0x20, 5, "home/bedroom/switch6")
i2cPin7 = i2c_pin.I2CPin(0x20, 6, "home/bedroom/switch7")
i2cPin8 = i2c_pin.I2CPin(0x20, 7, "home/bedroom/switch8")
